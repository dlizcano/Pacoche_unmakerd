...
```{r r calendar3,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE, error=FALSE, message=FALSE, fig.height=11,fig.width=8}
f.calendar.yr(dataset = pacoche.raw, yr_toplot = 2)
```
...
colnames(cont.per.sp)<-c("Numero_de_fotos")
...
est.veget<-read.csv("C:/code/ULEAM/Infor_Caract/pacoche/data/estructVegetPacoche.csv") # read table
...
```{r mat_sp5a,cache=TRUE,warning=FALSE,eval=TRUE, echo=FALSE,error=FALSE, message=FALSE, fig.height=4,fig.width=7}
