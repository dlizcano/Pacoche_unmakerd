...
par(mar = c(5, 4, 2, 2) + 0.1)
  ...
  plot(fit ~ elev, pred.data26, type="l", ylim=c(-0.1,1), col="blue",
       xlab="Elevation (m)",
       ylab="Detectability",
       xaxt="n")# 
  lines(low95 ~ elev, pred.data26, type="l", col=gray(0.5))
  lines(upp95 ~ elev, pred.data26, type="l", col=gray(0.5))
